...
function GlitchText({
  ...
  return (
    <span className={`relative inline-block group ${className}`}>
      ...
      <span
        className="absolute top-0 left-0 -z-10 opacity-0 group-hover:opacity-70 text-red-500 group-hover:animate-glitch-1"
        aria-hidden="true"
      >
        {children}
      </span>
      <span
        className="absolute top-0 left-0 -z-10 opacity-0 group-hover:opacity-70 text-cyan-500 group-hover:animate-glitch-2"
        aria-hidden="true"
      >
        {children}
      </span>
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        >
          <span className="mr-1">$</span> cat README.md{" "}
  ...
  const secondaryStats = [
    {
      ...
      value: githubStats
        ...
        : "1000+",
      subtitle: githubStats?.firstContribution
        ? `Since ${githubStats.firstContribution}`
        : "Lifetime",
      color: "green",
    },
    {
    ...
    },
    {
      ...
      label: "This Year",
      value: githubStats
        ? `${githubStats.contributionsThisYear.toLocaleString()}`
        : "500+",
    ...
    },
    {
      ...
      subtitle: githubStats?.accountCreated
        ? `Since ${githubStats.accountCreated}`
        : "",
      color: "purple",
    },
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 font-mono text-[10px] text-gray-500/5 dark:text-gray-400/5 overflow-hidden select-none">
          <div className="absolute top-20 left-10">
            git clone https://github.com/voxdroid/core.git
          </div>
          ...
          <div className="absolute top-[400px] left-20">
            [READY] Systems initialized in 42ms
          </div>
          <div className="absolute top-[500px] right-40">
            [CORE] Neural interface connected
          </div>
        </div>
      </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="lg:w-3/5 w-full">
            ...
            <div className="bg-gray-50 dark:bg-[#0d1117] rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700/50 overflow-hidden">
              ...
              <div className="p-4 sm:p-6 font-mono text-sm">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8">
                  ...
                  <div className="flex-grow text-xs sm:text-sm space-y-1">
                    <motion.div
                      ...
                      animate={{
                        opacity: asciiVisible.length > 2 ? 1 : 0,
                        x: asciiVisible.length > 2 ? 0 : 10,
                      }}
                    ...
                    {[
                      ...
                      <motion.div
                        ...
                        className="flex"
                      >
                        <span className="text-green-600 dark:text-green-400 w-20 flex-shrink-0">
                          {item.label}
                        </span>
                    ...
                    <motion.div
                      ...
                      animate={{
                        opacity:
                          asciiVisible.length >= voxAsciiArt.length ? 1 : 0,
                      }}
                ...
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{
                    opacity: asciiVisible.length >= voxAsciiArt.length ? 1 : 0,
                  }}
                ...
                >
                  ...
                  <div className="text-gray-400">VOXDROID v1.2.0 | UTF-8</div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-8 justify-center lg:justify-start">
              ...
              >
                <span className="text-green-300 mr-2">$</span> ls ./projects{" "}
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
              <Link
                href="/contact"
              ...
              >
                <span className="text-cyan-500 dark:text-cyan-300 mr-2">$</span>{" "}
                ./contact.sh
              </Link>
              <a
                          ...
                          <div className="flex items-center gap-2 p-3 rounded-lg bg-gray-50 dark:bg-[#161b22] border border-gray-200 dark:border-gray-700/50 hover:border-green-500/50 transition-colors">
                            ...
                            <div className="flex-grow min-w-0">
                              <div className="flex items-baseline justify-between gap-2">
                                <span
                                  className={`${color.text} text-xs truncate`}
                                >
                                  {stat.label}
                                </span>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="flex items-end gap-[2px] h-16">
                      {(
                        githubStats?.contributionGraph || Array(52).fill(0)
                      ).map((count, i) => {
                        const maxCount = Math.max(
                          ...(githubStats?.contributionGraph || [1]),
                          1,
                        );
                        const height =
                          count > 0
                            ? Math.max(15, (count / maxCount) * 100)
                            : 5;
                        const intensity =
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700">
                  {(
                    ...
                    const activityIcons: Record<
                      string,
                      { icon: typeof GitCommit; color: string }
                    > = {
                    ...
                    const { icon: ActivityIcon, color } =
                      activityIcons[activity.type] || activityIcons.activity;
                    ...
                    return (
                      ...
                      >
                        <ActivityIcon
                          className={`w-4 h-4 mt-0.5 ${color} flex-shrink-0`}
                        />
                        <div className="flex-grow min-w-0">
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700/50 flex items-center justify-between text-xs">
                  <span className="text-gray-500">
                    <span className="text-green-500">
                      {githubStats?.contributionsThisYear || 0}
                    </span>{" "}
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700/50">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-400">
                    <span className="text-green-500">█</span> github.api loaded
                    • {githubStats ? "live data" : "cached"}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-2 font-mono">
                <span className="text-green-600 dark:text-green-400">$</span>{" "}
                <span className="text-gray-700 dark:text-gray-300">ls</span>{" "}
            ...
            <div className="mt-12 text-center">
              <Link
                ...
                className="px-6 py-3 bg-green-600 hover:bg-green-500 text-white rounded-md shadow-lg transition-all duration-300 hover:translate-y-[-3px] hover:shadow-green-500/25 inline-flex items-center font-mono text-sm"
              >
                <span className="text-green-300 mr-2">$</span> ls -la ./projects{" "}
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                  Designing and implementing ML models for data analysis,
                  prediction, and automation using Python and modern frameworks.
                </p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-green-100 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-xs rounded font-mono">
                    python
                  </span>
                  <span className="px-2 py-1 bg-blue-100 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 text-xs rounded font-mono">
                    tensorflow
                  </span>
                  <span className="px-2 py-1 bg-yellow-100 dark:bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 text-xs rounded font-mono">
                    pytorch
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                  Building cross-platform desktop applications with focus on
                  functionality, performance, and user-friendly interfaces.
                </p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-purple-100 dark:bg-purple-500/10 text-purple-700 dark:text-purple-400 text-xs rounded font-mono">
                    qt
                  </span>
                  <span className="px-2 py-1 bg-cyan-100 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 text-xs rounded font-mono">
                    electron
                  </span>
                  <span className="px-2 py-1 bg-orange-100 dark:bg-orange-500/10 text-orange-700 dark:text-orange-400 text-xs rounded font-mono">
                    tkinter
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                  Crafting efficient, scalable software solutions with a focus
                  on clean code, robust architectures, and best practices.
                </p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-red-100 dark:bg-red-500/10 text-red-700 dark:text-red-400 text-xs rounded font-mono">
                    git
                  </span>
                  <span className="px-2 py-1 bg-green-100 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-xs rounded font-mono">
                    linux
          ...
          <div className="mt-12 text-center">
            ...
            >
              ...
              cat ./about/skills <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative overflow-hidden bg-gray-100 dark:bg-[#0d1117] z-10">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <span className="text-green-300 mr-2">$</span> ./initiate-contact.sh{" "}
