...
const project = {
  ...
  longDescription: `
  <p>A modern, customizable, and responsive tech website template built with <span style="color: #3b82f6 !important;">Next.js</span>. and <span style="color: #3b82f6 !important;">TypeScript</span>.</p>
`,
  image: "/project_images/Shibaccus.png",
  date: "March 2025",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Next.js", "TypeScript", "Tailwind CSS", "Tech Website", "UI/UX", "Template"],
  ...
  features: [
    "<strong>Modern UI/UX:</strong> Rose gold-themed design with glass morphism effects.",
    "<strong>Responsive Layout:</strong> Optimized for mobile, tablet, and desktop devices.",
    "<strong>Interactive Animations:</strong> Smooth transitions powered by Framer Motion.",
    "<strong>Dark/Light Mode:</strong> Seamless theme switching with local storage support.",
    "<strong>Comprehensive Pages:</strong> Includes Home, Services, Portfolio, Blog, Pricing, About, Contact, and FAQ.",
    "<strong>Accessibility:</strong> ARIA-compliant and keyboard-navigable.",
    "<strong>Performance Optimized:</strong> Fast load times with optimized assets and Next.js features.",
    "<strong>Blog Functionality:</strong> Articles with search capabilities.",
    "<strong>Contact Form:</strong> Validated form for user inquiries.",
  ],
  challenges: [
  ],
  solutions: [
