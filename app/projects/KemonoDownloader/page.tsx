...
const project = {
  id: 1,
  title: "Kemono.su Downloader",
  description: "A cross-platform Python app built with PyQt6 to download posts and creator content from Kemono.su.",
  longDescription: `
  <p><strong>Kemono Downloader</strong> - A cross-platform Python app built with PyQt6 to download posts and creator content from Kemono.su.</p>
  <br>
  <p>Supports concurrent downloads, file deduplication, and customizable settings.<p>
  `,
  image: "/project_images/KemonoDownloader.png",
  date: "March 2025",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Python", "PyQt6", "Kemono.su", "Kemono Party", "Downloader", "Threading"],
  category: "Desktop Application",
  github: "https://github.com/VoxDroid/KemonoDownloader",
  demo: "https://voxdroid.github.io/KemonoDownloader/",
  screenshots: [
    "/project_screenshots/KemonoDownloader/kd_pdown.png",
    "/project_screenshots/KemonoDownloader/kd_cdown.png",
    "/project_screenshots/KemonoDownloader/kd_settings.png",
  ],
  features: [
    "<strong>Post Downloading:</strong> Easily download files from specific Kemono.su posts using their URLs.",
    "<strong>Creator Archiving:</strong> Bulk download all posts and files from a creator's profile with a single click.",
    "<strong>File Type Support:</strong> Handle images (JPG, PNG, GIF), videos (MP4), archives (ZIP, 7Z), PDFs, and more.",
    "<strong>Concurrent Downloads:</strong> Adjust the number of simultaneous downloads (1-10) for optimal performance.",
    "<strong>File Deduplication:</strong> Prevent redundant downloads using URL hashes.",
    "<strong>Image Previews:</strong> Preview images before downloading to verify content.",
    "<strong>Customizable Settings:</strong> Tailor save directories, folder names, notifications, and themes to your preference.",
    "<strong>Detailed Logging:</strong> Track progress and troubleshoot issues with an in-app console.",
    "<strong>Cross-Platform UI:</strong> Built with PyQt6 for a modern, intuitive interface compatible with multiple operating systems.",
  ],
  challenges: [
  ],
  solutions: [
  ...
  techStack: [
    ...
    { name: "PyQt6", description: "GUI framework for dekstop interfaces." },
    { name: "Requests", description: "Library for HTTP requests." },
    { name: "Hashlib", description: "Library for deduplication." },
    { name: "Threading", description: "Concurrency support." },
    { name: "OS/Pathlib", description: "File management libraries." },
