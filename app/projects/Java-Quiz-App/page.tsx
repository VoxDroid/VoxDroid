...
const project = {
  id: 1,
  title: "JavaFX Quiz App",
  description: "A Java desktop application built with JavaFX in IntelliJ IDEA.",
  longDescription: `
  <p>Welcome to <strong>JavaFX Quiz App</strong>, a feature-rich desktop quiz application built with <strong>JavaFX</strong> and <strong>SQLite</strong>. This application provides an engaging and interactive platform for creating, managing, and playing quizzes with a modern user interface. Designed for educators, students, and trivia enthusiasts, JavaFX Quiz App combines robust functionality with a sleek, customizable experience.</p>
  `,
  image: "/project_images/JavaQuiz.png",
  date: "October 2024",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Java", "JavaFX", "IntelliJ", "Quiz App", "Desktop Application"],
  category: "Desktop Application",
  github: "https://github.com/VoxDroid/Java-Quiz-app",
  ...
  features:  [
    "<strong>Quiz Management:</strong> Create, edit, and delete quizzes with customizable names and categories, featuring auto-incrementing quiz numbers for easy tracking.",
    "<strong>Question Creation:</strong> Add and edit multiple-choice and identification questions with up to four answer options, all stored in a persistent SQLite database.",
    "<strong>Interactive Quiz Gameplay:</strong> Play quizzes with dynamic interface featuring progress bars, timers, animated transitions, randomized questions, and score tracking.",
    "<strong>Configurable Quiz Settings:</strong> Customize the number of questions, time per question, timer visibility, animation effects, and answer submission modes.",
    "<strong>Multilingual Support:</strong> Access the application in eight languages including English, Japanese, Filipino, Korean, Chinese, German, Russian, and Spanish.",
    "<strong>Modern UI Design:</strong> Responsive JavaFX interface with fade transitions between views and particle-based background animations for an engaging visual experience.",
    "<strong>Toggleable Animations:</strong> Enable or disable animations for a smoother user experience or lighter resource consumption based on preference.",
    "<strong>Persistent Data Storage:</strong> Robust SQLite database for storing quizzes, questions, and answers with automatic schema creation and migration handling.",
    "<strong>Detailed Score Tracking:</strong> View comprehensive results at the end of each quiz with immediate answer feedback and performance analytics.",
    "<strong>User-Friendly Interface:</strong> Intuitive desktop application built with JavaFX featuring smooth transitions and localized UI elements for accessibility.",
  ],
  challenges: [
  ],
  solutions: [
  ...
  techStack: [
    { name: "Java", description: "Core programming language (version 17 or higher)." },
    { name: "JavaFX", description: "GUI framework for building responsive desktop interfaces with modern UI components." },
    { name: "SQLite", description: "Lightweight relational database for persistent storage of quizzes, questions, and answers." },
    { name: "Maven", description: "Dependency management and build automation tool for project compilation and packaging." },
    { name: "SQLite JDBC", description: "Java driver for database connectivity and CRUD operations." },
    { name: "FXML", description: "XML-based markup language for defining JavaFX user interface layouts." },
    { name: "CSS", description: "Styling language for customizing JavaFX component appearance and themes." },
    { name: "Properties Files", description: "Configuration files for multilingual support across eight languages." },
    { name: "IntelliJ IDEA", description:  "Recommended IDE for development, debugging, and running the application." },
    { name: "JUnit", description: "Testing framework for unit testing core functionalities and database operations." },
  ],
}
