...
const project = {
  id: 1,
  title: "vox-md",
  description: "A Rust-Based CLI Tool to Convert Markdown Files to PDF with Customizable Formatting and Templates",
  longDescription: `
  <p><strong>vox-md</strong> is an open-source command-line interface (CLI) tool written in Rust that converts Markdown files to professionally formatted PDF documents. Leveraging the <code>pulldown-cmark</code> library for Markdown parsing and <code>wkhtmltopdf</code> for PDF generation, it offers customizable templates, page sizes, margins, font sizes, and orientations. Designed for developers, writers, and documentation enthusiasts, vox-md simplifies the process of creating polished PDFs from Markdown with minimal setup.</p>
  <br>
  <p>The tool supports three built-in HTML templates (<code>default</code>, <code>modern</code>, <code>minimal</code>) for styling, and users can create custom templates for further personalization. With verbose logging and robust error handling, vox-md ensures a reliable and user-friendly experience.</p>
  `,
  image: "/project_images/VOXMD.png",
  date: "May 2025",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Rust", "Markdown", "Command-line", "Regex", "Converter", "Rust-CLI"],
  ...
  "features": [
    "<strong>Blazing-Fast Conversion:</strong> Built with Rust, delivering lightning-quick processing and robust memory safety for converting Markdown files to PDF.",
    "<strong>Customizable Formatting:</strong> Offers flexible options for font styles, sizes, colors, and layouts, empowering users to tailor PDF output to their unique branding or documentation needs.",
    "<strong>Template Support:</strong> Easily apply custom or built-in templates to achieve consistent and professional appearance across all rendered documents.",
    "<strong>Zero-Dependency Binary:</strong> Compiles into a standalone executable with no external runtime dependencies, ensuring hassle-free installation and reliable performance on any supported platform.",
    "<strong>Cross-Platform CLI Tool:</strong> Runs smoothly on Linux, macOS, and Windows, integrating effortlessly into your development workflow or automation scripts.",
    "<strong>Intuitive Command-Line Interface:</strong> Simple, well-documented command-line arguments and helpful flag descriptions make it easy for both beginners and power users.",
    "<strong>Open Source & Community-Driven:</strong> Freely available under an open-source license, inviting contributions, suggestions, and new features from users everywhere."
  ],
  "challenges": [
  ],
  solutions: [
  ...
  "techStack": [
    { "name": "Rust", "description": "Core programming language ensuring fast, safe, and efficient PDF generation from Markdown input." },
    { "name": "Cargo", "description": "Rust’s package manager and build system, managing dependencies and building reliable, cross-platform binaries." },
    { "name": "Clap", "description": "Rust library for parsing command-line arguments, creating clear, accessible, and flexible CLI options." },
    { "name": "Pulldown-Cmark", "description": "A fast, GitHub-flavored Markdown parser in Rust, used to accurately and efficiently parse Markdown files." },
    { "name": "Html2Pdf or Printpdf / Pdfium-render (Rust PDF Libraries)", "description": "Handles rendering HTML or Markdown content to high-quality PDF documents, supporting advanced formatting and templates." },
    { "name": "Linux, macOS, Windows", "description": "Tested and built for compatibility with all major desktop operating systems." },
    { "name": "GitHub Actions", "description": "Powering the automated CI/CD pipeline for testing builds, linting, and releases." },
    { "name": "GitHub", "description": "Platform for open-source collaboration, version control, community contributions, and release management." }
  ]
}
