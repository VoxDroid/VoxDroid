...
const project = {
  ...
  description: "A comprehensive collection of 300 x86-64 assembly language code snippets (using NASM syntax on Linux).",
  longDescription: `
  <p>This project is a comprehensive collection of 300 x86-64 assembly language code snippets (using NASM syntax on Linux) for learning and demonstration. The snippets are categorized into three difficulty levels:<p><br>
  <ul>
    <li><strong>Basic (1-100):</strong> Foundational concepts for beginners, covering syntax, registers, and basic operations.</li>
    <li><strong>Intermediate (101-200):</strong> More complex techniques, including functions, memory management, and optimization.</li>
    <li><strong>Advanced (201-300):</strong> Specialized applications, such as OS development, reverse engineering, and performance-critical code.</li>
  </ul><br>
  <p>Each snippet resides in its own folder (<code>assembly-300-snippets/XXXX-Title-Name</code>) with a CHEETSHEET.md and SAMPLES.md files, and a README.md explaining the code, its purpose, and usage instructions.</p>
  `,
  ...
  "features": [
    "<strong>Extensive Snippet Collection:</strong> Contains 300 carefully curated NASM x86-64 assembly code snippets for diverse programming tasks.",
    "<strong>Linux-Focused:</strong> All code is tested and written for Linux systems, ensuring high compatibility and practical utility.",
    "<strong>Clear Organization:</strong> Snippets are organized for easy navigation—quickly find code by topic or function.",
    "<strong>Educational Value:</strong> Ideal for learners and practitioners, each snippet demonstrates common algorithms, system calls, and assembly concepts.",
    "<strong>NASM Syntax:</strong> All snippets use NASM (Netwide Assembler) standard syntax, promoting consistency and best practices.",
    "<strong>Ready to Use:</strong> Code is copy-paste ready, with concise comments for fast learning and integration."
  ],
  "challenges": [
  ],
  solutions: [
  ...
  "techStack": [
    { "name": "x86-64 Assembly", "description": "Primary programming language for all code snippets." },
    { "name": "NASM", "description": "Netwide Assembler used for writing and assembling code." },
    { "name": "Linux", "description": "Target operating system for compiling and running all snippets." },
    { "name": "GNU Make", "description": "Used for building and automating assembly compilation (if build files included)." },
    { "name": "Bash/Shell", "description": "Shell commands and scripts for running and testing snippets (where applicable)." },
    { "name": "GitHub", "description": "Platform for version control, collaboration, and sharing." }
  ]
}
