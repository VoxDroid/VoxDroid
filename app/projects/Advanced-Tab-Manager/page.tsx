...
const project = {
  ...
  description: "A powerful GUI tool built with Python, PyQt6, and Selenium to automate Chrome tab management. With multi-instance support, multilingual interface, and customizable themes, it’s ideal for browser automation, testing, and repetitive tasks.",
  longDescription: `
  <p>Welcome to <strong>Advanced Tab Manager</strong>, a Python-based desktop application built with <strong>PyQt6</strong> and <strong>Selenium</strong>, designed to automate browser tab management with extensive customization options. This tool is ideal for developers, testers, and automation enthusiasts needing to efficiently manage multiple Chrome tabs across multiple instances, with features like headless mode, proxy support, multilingual interface, and real-time system monitoring.
  `,
  image: "/project_images/ATM.png",
  date: "Feb 24 2025",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Python", "PyQt6", "Selenium", "Automation", "Cross-Platform", "Chrome-automation"],
  category: "Desktop Application",
  github: "https://github.com/VoxDroid/Advanced-Tab-Manager",
  ...
  features: [
    "<strong>Multi-Instance Tab Management:</strong> Run multiple Google Chrome instances simultaneously, each managing its own set of tabs.",
    "<strong>Customizable Browser Options:</strong> Support for headless mode, incognito, proxy settings, custom user agents, and additional Chrome arguments.",
    "<strong>Multilingual Interface:</strong> Supports English, Japanese, Korean, Chinese, and Filipino with dynamic language switching.",
    "<strong>Themeable Interface:</strong> Choose from six visually appealing themes (Dark Navy, Light Blue, Dark Green, Light Green, Soft Pink, Soft Lavender).",
    "<strong>Real-Time System Monitoring:</strong> Track CPU, memory, and disk usage with live updates using psutil.",
    "<strong>Detailed Logging:</strong> Color-coded logs with filtering (INFO, WARNING, ERROR) and export capabilities.",
    "<strong>Advanced Configuration:</strong> Fine-tune browser behavior with proxy settings, user agent customization, and Chrome command-line arguments.",
    "<strong>Automatic Updates:</strong> Check for new versions on startup with optional notifications using requests.",
    "<strong>Cross-Platform GUI:</strong> Built with PyQt6 for a modern, intuitive interface compatible with Windows, macOS, and Linux.",
    "<strong>Process Management:</strong> Robust handling of Chrome and ChromeDriver processes to prevent resource leaks.",
    "<strong>Error Handling:</strong> Comprehensive error detection and logging for reliable operation.",
  ],
  challenges: [
  ],
  solutions: [
  ...
  techStack: [
    ...
    { name: "PyQt6", description: "GUI framework for the desktop interface." },
    { name: "Selenium", description: "Browser automation and tab management." },
    { name: "psutil", description: "Real-time system monitoring (CPU, memory, disk)." },
    { name: "qtawesome", description: "Icons for the PyQt6 interface." },
    { name: "webdriver-manager", description: "Automated ChromeDriver management." },
    { name: "Requests", description: "HTTP requests for version checking and updates." },
    { name: "Packaging", description: "Version parsing and comparison." },
  ],
}
