...
const project = {
  id: 1,
  title: "linux-auto",
  description: "Automates routine Linux tasks using shell scripts for improved efficiency and system management.",
  longDescription: `
  <p><strong>linux-auto</strong> is a repository containing shell scripts for automating a range of Linux system tasks. The scripts are intended to support standard operations such as maintenance, scheduling, and resource management. This project provides modular components suitable for integration and customization within different Linux workflows.</p>
  `,
  image: "/project_images/linux-auto.png",
  date: "May 2025",
  client: "Open Source Community",
  role: "Lead Developer",
  tags: ["Linux", "Shell", "Scripts", "Automation", "System Admin/Operations", "Workflows"],
  ...
  "features": [
    "<strong>Task Automation Engine:</strong> Executes routine and repetitive Linux system tasks automatically using efficient shell scripts, streamlining system maintenance.",
    "<strong>Built Exclusively with Shell:</strong> Harnesses the native power of Bash and other shell commands, requiring no compilation or extra dependencies—works out-of-the-box on any Linux system.",
    "<strong>Modular Script Design:</strong> Organized into reusable, composable script modules, making it easy to adapt or extend for specific use cases.",
    "<strong>Easy Customization:</strong> Users can edit variables or script sections to match their workflow—no programming experience required.",
    "<strong>System Management Tools:</strong> Provides scripts for backup, cleanup, updates, user management, resource monitoring, and more, improving system reliability and efficiency.",
    "<strong>Clear Logging & Output:</strong> Outputs informative logs and status messages for transparency, making it easy to monitor script actions and troubleshoot issues.",
    "<strong>Open Source & Extensible:</strong> Freely available and designed to be community-driven, welcoming new scripts, improvements, and features from contributors."
  ],
  "challenges": [
  ],
  solutions: [
  ...
  "techStack": [
    { "name": "Shell (Bash)", "description": "Primary scripting language, leveraging the power, portability, and built-in utilities of the Linux shell environment for task automation." },
    { "name": "Linux", "description": "Target operating system, providing native tools and features used and automated by the scripts." },
    { "name": "Cron", "description": "Unix-based scheduler often leveraged to automatically run maintenance or monitoring shell scripts at regular intervals." },
    { "name": "Core GNU Utilities", "description": "Essential CLI tools such as grep, awk, sed, rsync, and find—integral for manipulating files, filtering data, and managing system resources." },
    { "name": "Systemd", "description": "Can be used for managing automated service scripts, timers, and system tasks for enhanced reliability." },
    { "name": "GitHub Actions", "description": "Supports continuous integration workflows and automated testing of scripts in the repository." },
    { "name": "GitHub", "description": "Collaborative platform for code hosting, community contributions, and version control." }
  ],
}
