...
const project = {
  ...
  longDescription: `
  <p>Welcome to <strong>Zylthra</strong>, a powerful Python-based desktop application built with PyQt6, designed to generate synthetic datasets using the DataLLM API from <a href="https://data.mostly.ai" target="_blank" style="color:hsl(244, 86.70%, 64.50%);">data.mostly.ai</a>. This tool allows users to create custom datasets by defining columns, configuring generation parameters, and saving setups for reuse, all within a sleek, dark-themed interface.</p>
  `,
  ...
  features: [
    "<strong>Synthetic Data Generation:</strong> Create datasets with custom columns using DataLLM’s AI capabilities.",
    "<strong>Column Customization:</strong> Define column names, prompts, data types, token limits, regex patterns, and categories.",
    "<strong>Flexible Row Options:</strong> Generate 10 to 50,000 rows or specify a custom number.",
    "<strong>Advanced Settings:</strong> Adjust temperature, model selection (e.g., Mistral, Mixtral, LLaMA), and iteration limits.",
    "<strong>Configuration Management:</strong> Save, load, and delete dataset configurations for quick reuse.",
    "<strong>Output Control:</strong> Customize filenames, add timestamps, choose save locations, and include ID columns.",
    "<strong>Progress Tracking:</strong> Real-time progress bar and status updates during generation.",
    "<strong>Cross-Platform UI:</strong> Modern, dark-themed interface built with PyQt6, compatible with Windows, macOS, and Linux.",
    "<strong>In-App Help:</strong> Comprehensive documentation accessible via the Help tab.",
  ],
  challenges: [
  ],
  solutions: [
